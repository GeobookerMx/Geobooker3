                ...
                {status === 'error' && (
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-gray-400 mt-4">
                            Por favor envía un correo a <a href="mailto:hola@geobooker.com.mx" className="text-blue-600 underline">hola@geobooker.com.mx</a> para que te demos de baja manualmente.
                        </p>
                    </div>
                )}
            </div>
