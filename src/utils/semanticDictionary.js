...
const SEMANTIC_GROUPS = [
  ...
  ['dry_cleaning', ['lavanderia', 'lavandería', 'lavanderias', 'lavanderías', 'lavar ropa', 'planchaduria', 'planchaduría', 'planchadurias', 'planchadurías', 'planchado de ropa', 'planchado camisas', 'planchado', 'laundromat', 'laundry', 'tintoreria', 'tintorería', 'tintorerias', 'tintorerías', 'dry cleaning', 'ironing service']],
  ...
  ['power_transmission', ['balero', 'baleros', 'rodamiento', 'rodamientos', 'chumacera', 'chumaceras', 'banda industrial', 'bandas industriales', 'polea', 'poleas', 'engrane', 'engranes', 'reten', 'retenes', 'manguera hidraulica', 'mangueras hidraulicas', 'conexiones hidraulicas', 'hydraulic hose', 'bearings', 'power transmission', 'industrial belt']],
  ['electrical_supplies', ['material electrico', 'cable electrico', 'cable calibre', 'apagador', 'contacto', 'breaker', 'pastilla termica', 'centro de carga', 'conduit', 'tubo conduit', 'electric supplies', 'electrical supply', 'wire', 'circuit breaker']],
  ['plumbing_supplies', ['material de plomeria', 'tuberia pvc', 'cpvc', 'pex', 'cobre', 'valvula', 'valvulas', 'cople', 'codos', 'tinaco', 'bomba de agua', 'llave mezcladora', 'plumbing supplies', 'pipe fittings', 'water pump']],
  ['hvac_refrigeration', ['minisplit', 'aire acondicionado', 'clima', 'compresor refrigeracion', 'gas refrigerante', 'refrigeracion comercial', 'camara fria', 'evaporador', 'condensador', 'hvac', 'air conditioning', 'commercial refrigeration']],
  ['lab_dental_supplies', ['material dental', 'resina dental', 'reactivos laboratorio', 'tubos vacutainer', 'material clinico', 'instrumental dental', 'dental supplies', 'laboratory supplies', 'clinical supplies']],
  ['uniforms_textiles', ['uniforme', 'uniformes', 'bordado', 'bordados', 'serigrafia', 'sublimacion', 'playeras personalizadas', 'textiles', 'telas', 'mandiles', 'custom uniforms', 'embroidery', 'screen printing']],
  ['solar_energy', ['panel solar', 'paneles solares', 'inversor solar', 'bateria solar', 'microinversor', 'estructura solar', 'energia solar', 'solar panels', 'solar installer', 'solar battery']],
  ['professional_services', ['contador', 'contadora', 'resico', 'facturacion', 'declaracion anual', 'abogado', 'notaria', 'contrato', 'asesoria fiscal', 'accountant', 'lawyer', 'tax advisor', 'legal services']],
  ...
  ['real_estate', ['inmobiliaria', 'renta de casas', 'venta de casas', 'departamentos', 'real estate', 'realtor', 'property', 'renta de locales', 'renta de oficinas', 'coworking', 'renta de espacio', 'renta de espacios', 'alquiler de local', 'alquiler de oficina', 'locales comerciales', 'oficinas en renta', 'espacio de trabajo', 'pension para autos', 'pension nocturna', 'garage en renta', 'cochera en renta', 'cajon de estacionamiento', 'estacionamiento nocturno', 'monthly parking']],
  ...
  ['voice_search', ['negocios cerca de mi', 'servicios cerca de mi', 'que hay cerca de mi', 'donde encuentro un plomero', 'donde hay una farmacia abierta', 'necesito una vulcanizadora', 'busco un cerrajero urgente', 'comida cerca de mi', 'barberia cerca de mi', 'taller mecanico cerca', 'tornillo de cuerda 3/8 cerca de mi', 'businesses near me', 'services near me', 'restaurants near me', 'tire repair near me', 'plumber near me', 'locksmith near me', 'pharmacy near me', 'coffee shop near me', 'fasteners near me', 'insumos medicos cerca', 'beauty supply near me', 'auto parts near me', 'equipo de seguridad industrial', 'restaurant equipment near me', 'agroinsumos cerca', 'material electrico cerca', 'plumbing supplies near me', 'mangueras hidraulicas cerca', 'hvac supplies near me', 'uniformes cerca', 'solar panels near me', 'contador cerca']],
