...
const SEMANTIC_GROUPS = [
  ...
  ['pharmacy', ['farmacia', 'medicina cerca', 'farmacia abierta', 'farmacia 24 horas', 'drugstore', 'pharmacy near me', 'medicine', 'botica', 'drogueria', 'chemist']],
  ...
  ['beauty_salon', ['estetica', 'unas', 'maquillaje', 'cabello', 'beauty salon', 'nail salon', 'hair salon', 'salon de belleza']],
  ['dry_cleaning', ['lavanderia', 'lavar ropa', 'laundromat', 'laundry', 'tintoreria', 'dry cleaning']],
  ['hardware_store', ['ferreteria', 'tornillos', 'herramientas', 'tlapaleria', 'hardware store', 'tools', 'construction supplies', 'casa de materiales']],
  ...
  ['industrial_supplies', ['insumos industriales', 'suministros industriales', 'componentes industriales', 'refacciones industriales', 'maquinaria', 'equipo industrial', 'industrial supplies', 'industrial components', 'spare parts', 'machine parts']],
  ...
  ['moving_service', ['mudanza', 'flete', 'transporte de muebles', 'moving service', 'movers', 'relocation']],
  ...
  ['voice_search', ['negocios cerca de mi', 'servicios cerca de mi', 'que hay cerca de mi', 'donde encuentro un plomero', 'donde hay una farmacia abierta', 'necesito una vulcanizadora', 'busco un cerrajero urgente', 'comida cerca de mi', 'barberia cerca de mi', 'taller mecanico cerca', 'businesses near me', 'services near me', 'restaurants near me', 'tire repair near me', 'plumber near me', 'locksmith near me', 'pharmacy near me', 'coffee shop near me']],
