...
export const getAlternateUrls = (path = '/') => {
  ...
  return {
    en: GLOBAL_CANONICAL_ORIGIN + normalizedPath,
    'en-US': GLOBAL_CANONICAL_ORIGIN + normalizedPath,
    es: MEXICO_CANONICAL_ORIGIN + normalizedPath,
    'es-MX': MEXICO_CANONICAL_ORIGIN + normalizedPath,
    'x-default': GLOBAL_CANONICAL_ORIGIN + normalizedPath,
  };
};
