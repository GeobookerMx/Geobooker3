...
/**
 * Exportaciones centralizadas de componentes de anuncios
 * Uso: import { HeroBanner, CarouselAd } from '@/components/ads';
 */

export { default as HeroBanner } from './HeroBanner';
export { default as CarouselAd } from './CarouselAd';
