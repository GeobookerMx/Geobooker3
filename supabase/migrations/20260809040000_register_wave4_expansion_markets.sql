-- Register Wave 4 expansion cities in international_markets.
-- São Paulo (BR), New York (US), Mexico City (MX)
...
INSERT INTO public.international_markets (
  ...
  ('br-sao-paulo',   'BR', 'Brazil',        'São Paulo',   'pt', 'America/Sao_Paulo', 4, 'candidate', 0, 1000, '2026-06-17.0', FALSE),
  ('us-new-york',    'US', 'United States', 'New York',    'en', 'America/New_York',  4, 'candidate', 0, 1000, '2026-06-17.0', FALSE),
  ('mx-mexico-city', 'MX', 'Mexico',        'Mexico City', 'es', 'America/Mexico_City', 4, 'candidate', 0, 1000, '2026-06-17.0', FALSE)
...
FROM (
  ...
  WHERE country_code IN ('BR', 'US', 'MX')
